                ...
                <div class="section__wrapper_content_inner">
                        <div class="section__wrapper_content_wrapper">
                            <div class="section__wrapper_content_wrapper_box">
                                <label for="name"><p class="section__wrapper_content_wrapper_ttl">Name.<span class="section__wrapper_content_wrapper_ttl_dec">*</span></p></label>
                                <input id="name" name="your-name" type="text" class="section__wrapper_content_wrapper_input">
                            </div>
                            <div class="section__wrapper_content_wrapper_box">
                                <label for="mail"><p class="section__wrapper_content_wrapper_ttl">Mail.<span class="section__wrapper_content_wrapper_ttl_dec">*</span></p></label>
                                <input id="mail" name="mail" type="email" class="section__wrapper_content_wrapper_input">
                            </div>
                            <div class="section__wrapper_content_wrapper_box">
                                <label for="tel"><p class="section__wrapper_content_wrapper_ttl">Phone.<span class="section__wrapper_content_wrapper_ttl_dec">*</span></p></label>
                                <input id="tel" name="tel" type="number" class="section__wrapper_content_wrapper_input tel">
                            </div>
                        </div>
                        <div class="section__wrapper_content_wrapper">
                            <label for="comment"><p class="section__wrapper_content_wrapper_ttl message">Message.<span class="section__wrapper_content_wrapper_ttl_dec">*</span></p></label>
                            <textarea id="comment" name="comment" id="" class="section__wrapper_content_wrapper_textarea"></textarea>
                        </div>
                    </div>
                    <div class="form_submit-box m-auto">
                        <div class="form_submit-box_inner">
                            <img class="button_email-img before" src="<?php echo get_template_directory_uri(); ?>/img/email-before.png" alt="">
                            <img class="button_email-img after" src="<?php echo get_template_directory_uri(); ?>/img/email-after.png" alt="">
